...
- Pan (Navegação): Pressione o botão do scroll (mouse wheel) e mova o mouse para deslocar a área de visualização.
- Importação de SVG: Suporte à importação de arquivos SVG contendo apenas elementos do tipo path.
- Multi-seleção:
